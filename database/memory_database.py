...
class MemoryDatabase:
    ...
    def create_embeddings(self, inputs: List[str]) -> List[List[float]]:
        ...
        for input_text in inputs:
            ...
            response = openai.Embedding.create(
                input=[input_text], engine=embed_model
            )
    ...
    def query_memories(self, query: str, top_k: int = 5) -> List[dict]:
        ...
        results = self.index.query(vector=embedding, top_k=top_k, include_metadata=True, include_values=False)
        return results.matches
    
    def update_memory(self, memory_id: str, new_content: Optional[str] = None, new_metadata: Optional[Dict[str, Any]] = None):
        if new_content:
    ...
    def fetch_index(self):
        return self.index.fetch(ids=['id1', 'id2'])
...
def main():
    ...
    programming_tasks = [
        {"id": "1", "content": "Implement a function to reverse a string in Python", "metadata": {"language": "Python"}},
        {"id": "2", "content": "Create a function to find the factorial of a number using recursion", "metadata": {"language": "Python"}},
        {"id": "3", "content": "Write a program to find the largest element in an array", "metadata": {"language": "Python"}},
        {"id": "4", "content": "Create a function to calculate the Fibonacci sequence using dynamic programming", "metadata": {"language": "Python"}},
        {"id": "5", "content": "Implement a function to sort a list of integers using the bubble sort algorithm", "metadata": {"language": "Python"}},
    ]
    ...
    for query in queries:
        ...
        for match in matches:
            print(f"  ID: {match['id']}, Content: {match['metadata']['content']}, Score: {match['score']}")
        print()
    ...
    memory_database.update_memory(memory_id="id-1", new_content="Implement a function to reverse a string in Python 3", new_metadata={"language": "Python 3"})
    ...
    print(memory_database.fetch_index())
